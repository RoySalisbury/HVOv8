                ...
                case 0x02:
                    {
                        ...
                        if (DateTime.Now.Subtract(this._lastDeviceStatePublish).TotalSeconds > 2)
                        {
                            ...
                            var balanceAction = JkMqtt.GenerateBinarySensorData(deviceId, "Balance Action", "balance_action", null, "measurement", null, null, ba, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var balancerStatus = JkMqtt.GenerateBinarySensorData(deviceId, "Balancer Status", "balancer_status", null, "measurement", null, null, bs, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
