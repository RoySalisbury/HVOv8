                ...
                case 0x02:
                    {
                        ...
                        if (DateTime.Now.Subtract(this._lastDeviceStatePublish).TotalSeconds > 2)
                        {
                            ...
                            var balanceAction = JkMqtt.GenerateSensorData(deviceId, "Balance Action", "balance_action", null, "measurement", null, null, ba, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var balancerStatus = JkMqtt.GenerateSensorData(deviceId, "Balancer Status", "balancer_status", null, "measurement", null, null, bs, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var ce = info.ChargingMosfetEnabled;
                            var chargingEnabled = JkMqtt.GenerateBinarySensorData(deviceId, "Charging Enabled", "charging_enabled", "battery_charging", "measurement", null, null, ce, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var de = info.DischarginMosfetEnabled;
                            var dischargingEnabled = JkMqtt.GenerateBinarySensorData(deviceId, "Discharging Enabled", "discharging_enabled", "battery_charging", "measurement", null, null, de, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            await JkMqtt.Publish(this._mqttClient, chargingEnabled.StateTopic, chargingEnabled.Value);
                            ...
                            await JkMqtt.Publish(this._mqttClient, dischargingEnabled.StateTopic, dischargingEnabled.Value);
