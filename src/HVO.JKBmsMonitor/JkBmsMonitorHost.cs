                ...
                case 0x02:
                    {
                        ...
                        if (DateTime.Now.Subtract(this._lastDeviceStatePublish).TotalSeconds > 2)
                        {
                            ...
                            var balanceAction = JkMqtt.GenerateSensorData(deviceId, "Balance Action", "balance_action", null, null, null, null, ba, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var balancerStatus = JkMqtt.GenerateSensorData(deviceId, "Balancer Status", "balancer_status", null, null, null, null, bs, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var ce = info.ChargingMosfetEnabled ? "On" : "Off";
                            var chargingEnabled = JkMqtt.GenerateSensorData(deviceId, "Charging Enabled", "charging_enabled", "battery_charging", "measurement", null, null, ce, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
                            ...
                            var dischargingEnabled = JkMqtt.GenerateSensorData(deviceId, "Discharging Enabled", "discharging_enabled", "battery_charging", "measurement", null, null, de, deviceName, "Jikong", deviceModel, hardwareVersion, softwareVersion, deviceSerialNumber);
