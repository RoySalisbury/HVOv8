...
namespace HVO.JKBmsMonitor
{
    ...
    public class JkBmsMonitorClient_OLD : IDisposable
    {
        private readonly ILogger<JkBmsMonitorClient_OLD> _logger;
        ...
        public JkBmsMonitorClient_OLD(ILogger<JkBmsMonitorClient_OLD> logger, IOptions<JkBmsMonitorClientOptions> jkBmsMonitorClientOptions)
        {
            this._logger = logger;
        ...
        public async Task Initialize(CancellationToken cancellationToken)
        {
            if (this._disposed)
            {
                throw new ObjectDisposedException(nameof(JkBmsMonitorClient_OLD));
            }
