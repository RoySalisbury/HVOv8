...
{
    public abstract class JkBmsGetCellInfoResponse : JkBmsResponse
    {
        ...
        public virtual bool ChargingStatus { get; protected set; }
        public virtual bool DischargingStatus { get; protected set; }

    }


    public class JkBmsGetCellInfo24Response : JkBmsGetCellInfoResponse
    {
        public JkBmsGetCellInfo24Response(ReadOnlyMemory<byte> data) : base(data) { }
        ...
        protected override void InitializeFromPayload()
        {
            ...
            this.ChargingStatus = payload[166] == 0x01;
            this.DischargingStatus = payload[167] == 0x01;

            this.BalancerStatus = payload[191];
        }
    }

    public class JkBmsGetCellInfo32Response : JkBmsGetCellInfoResponse
    {
        public JkBmsGetCellInfo32Response(ReadOnlyMemory<byte> data) : base(data) { }
        ...
        protected override void InitializeFromPayload()
        {
            ...
            this.ChargingStatus = payload[166 + offset] == 0x01;
            this.DischargingStatus = payload[167 + offset] == 0x01;
